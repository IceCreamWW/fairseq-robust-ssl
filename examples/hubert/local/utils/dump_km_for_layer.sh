...
nj=4
device=0
dumpdir=dump/raw/ls_960/official_iter2
kmeansdir=models/kmeans/official/
...
OPENBLAS_NUM_THREADS=20 python simple_kmeans/learn_kmeans.py $dumpdir/feat_from_hubert_base_ls960_L$layer train $nj $kmeansdir/ls_960_hubert_base_iter2_L${layer}_500.km 500 --percent 0.1

echo "dump train km label for layer $layer"
local/utils/dump_km_label.sh --feat_dir $dumpdir/feat_from_hubert_base_ls960_L$layer/ --split train --km_path $kmeansdir/ls_960_hubert_base_iter2_L${layer}_500.km --nj 4 --dst $dumpdir/km_from_hubert_base_ls960_L$layer/ --device $device
...
local/utils/dump_km_label.sh --feat_dir $dumpdir/feat_from_hubert_base_ls960_L$layer/ --split valid --km_path $kmeansdir/ls_960_hubert_base_iter2_L${layer}_500.km --nj 4 --dst $dumpdir/km_from_hubert_base_ls960_L$layer/ --device $device
