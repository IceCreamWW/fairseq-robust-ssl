...
model=exp/hubert_base_librispeech_train_ls_960_label_km_from_mfcc_ls960/final.pt
layer=2
nj=4
device=0
# dumpdir=dump/raw/ls_960/reproduce/iter1/
dumpdir=/mnt/lustre02/scratch/sjtu/home/ww089/fairseqs/fairseq-220604/examples/hubert/dump/raw/ls_960/reproduce/iter1
# kmeansdir=models/kmeans/reproduce/iter1/
kmeansdir=/mnt/lustre02/scratch/sjtu/home/ww089/fairseqs/fairseq-220604/examples/hubert/models/kmeans/reproduce/iter1
...
local/utils/dump_km_label.sh --feat_dir $dumpdir/feat_from_hubert_base_ls960_L$layer/ --split train --km_path $kmeansdir/ls_960_hubert_base_L${layer}_500.km --nj 4 --dst $dumpdir/km_from_hubert_base_ls960_L$layer/ --device $device
...
local/utils/dump_km_label.sh --feat_dir $dumpdir/feat_from_hubert_base_ls960_L$layer/ --split valid --km_path $kmeansdir/ls_960_hubert_base_L${layer}_500.km --nj 4 --dst $dumpdir/km_from_hubert_base_ls960_L$layer/ --device $device
